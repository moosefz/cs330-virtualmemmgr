...
**PAGE FAULT OCCURRED:**
  ...
  be executed:
    - ‘ memcpy(physicalMem + physMemPointer, backStoreMap + pageFront,
    ...
    - ‘ frameNum ’ will be set equal to ‘ physMemPointer ’ meaning it will be pointing to its
    dedicated memory.
    - Set ‘ physicalAddress ’ equal to ‘ frameNum ’ + ‘ offset ’
    - Set ‘ byteValue ’ equal to ‘ physicalMem[physicalAddress] .” This passes the
    ‘ physicalAddress ’ into our physical memory array to obtain the value in that
    address and stores it in ' byteValue '.
    - ‘ pageTable[pageNumber] = physMemPointer; This will insert ‘ frameNum ’ into the
    ‘ pageTable ’.
    - ‘ addToTLB(frameNum, pageNumber); ’ this will insert ‘ frameNum ’ into the
    ‘ tlBuffer ’.
    - Finally, we check if ‘ physMemPointer ’ is less than ‘ PM_SIZE ’ - 256. If it is, we
